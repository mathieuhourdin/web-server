...
pub use model::{
    JournalTraceView, NewTrace, NewTraceDto, PatchTraceDto, Trace, TraceSharingSensitivity,
...
pub use routes::{
    ...
    get_traces_for_journal_route, patch_journal_draft_route, patch_trace_route,
    post_finalized_journal_trace_route, post_journal_draft_route, post_trace_asset_route,
    post_trace_attachment_route, post_trace_document_attachment_route,
    post_trace_extend_timeout_route, post_trace_message_route, put_trace_route,
    put_trace_seen_route,
};
